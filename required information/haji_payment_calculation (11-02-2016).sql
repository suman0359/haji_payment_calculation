...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2016 at 03:55 PM
...
CREATE TABLE `history_give_and_take_new_loan` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `loan_history_of_installment` (
  `id` int(11) NOT NULL,
  `loan_user_id` varchar(10) NOT NULL,
...
--
-- Table structure for table `loan_transaction2`
--

CREATE TABLE `loan_transaction2` (
  `id` int(11) NOT NULL,
  `loan_user_id` varchar(10) NOT NULL,
  `paid_id` varchar(10) DEFAULT NULL,
  `receive_id` varchar(10) DEFAULT NULL,
  `loan_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'give_new_loan=1; take_new_loan=2; Receiveable_Installment = 3; Payble Installment =4;',
  `loan_against_id` varchar(10) NOT NULL COMMENT 'give and taken loan id from loan history',
  `loan_amount` varchar(10) NOT NULL,
  `profite_amount` varchar(10) DEFAULT NULL,
  `installment_amount` varchar(10) NOT NULL,
  `debit` varchar(20) NOT NULL,
  `credit` varchar(20) NOT NULL,
  `balance` varchar(20) NOT NULL,
...
--
-- Dumping data for table `loan_transaction2`
--

INSERT INTO `loan_transaction2` (`id`, `loan_user_id`, `paid_id`, `receive_id`, `loan_type`, `loan_against_id`, `loan_amount`, `profite_amount`, `installment_amount`, `debit`, `credit`, `balance`, `transaction_type`, `date`, `entry_by`, `status`) VALUES
(1, '28', NULL, '44', 1, '', '', '', '', '50000', '', '50000', 1, '2016-02-02', '', 1),
(2, '29', '45', NULL, 1, '', '', '', '', '', '30000', '20000', 1, '2016-02-02', '', 1),
(3, '28', NULL, '46', 1, '', '', '', '', '50000', '', '70000', 1, '2016-02-02', '', 1),
(4, '28', '47', NULL, 1, '', '', '', '', '', '40000', '30000', 1, '2016-02-02', '', 1),
(5, '29', '48', NULL, 1, '', '', '', '', '', '10000', '20000', 1, '2016-02-02', '', 1),
(6, '29', NULL, '49', 1, '', '', '', '', '5000', '', '25000', 1, '2016-02-02', '', 1),
(7, '29', NULL, '50', 1, '', '', '', '', '5000', '', '30000', 1, '2016-02-02', '', 1),
(8, '30', NULL, '54', 1, '', '', '', '', '50000', '', '80000', 1, '2016-02-03', '', 1),
(9, '30', '55', NULL, 1, '', '', '', '', '', '20000', '60000', 1, '2016-02-03', '', 1),
(10, '28', NULL, '56', 1, '', '', '', '', '30000', '', '90000', 1, '2016-02-06', '', 1);
...
CREATE TABLE `transactions` (
  ...
  `loan_user_id` varchar(10) NOT NULL,
  `loan_history_id` varchar(10) NOT NULL,
...
INSERT INTO `transactions` (`id`, `money_receipt_id`, `haji_id`, `loan_paid_id`, `loan_information_id`, `loan_receive_id`, `loan_user_id`, `loan_history_id`, `expense_id`, `date`, `balance_status`, `debit`, `credit`, `balance`, `last_transaction_amount`, `status`) VALUES
...
--
-- Indexes for table `history_give_and_take_new_loan`
--
ALTER TABLE `history_give_and_take_new_loan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transaction_type` (`transaction_type`),
...
--
-- Indexes for table `loan_history_of_installment`
--
ALTER TABLE `loan_history_of_installment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `loan_date` (`loan_date`),
  ADD KEY `loan_user_id` (`loan_user_id`),
  ADD KEY `against_given_taken_history` (`against_given_taken_history`);
...
ALTER TABLE `loan_transaction`
  ...
  ADD KEY `loan_type` (`loan_type`),
  ADD KEY `transaction_type` (`transaction_type`),
  ADD KEY `loan_against_id` (`loan_against_id`);

--
-- Indexes for table `loan_transaction2`
--
ALTER TABLE `loan_transaction2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `deposit_id` (`paid_id`),
  ADD KEY `withdrawal_id` (`receive_id`),
  ADD KEY `loan_user_id` (`loan_user_id`);
...
ALTER TABLE `transactions`
  ...
  ADD KEY `date` (`date`),
  ADD KEY `loan_history_id` (`loan_history_id`),
  ADD KEY `loan_user_id` (`loan_user_id`);
...
--
-- AUTO_INCREMENT for table `history_give_and_take_new_loan`
--
ALTER TABLE `history_give_and_take_new_loan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `loan_history_of_installment`
--
ALTER TABLE `loan_history_of_installment`
...
--
-- AUTO_INCREMENT for table `loan_transaction2`
--
ALTER TABLE `loan_transaction2`
