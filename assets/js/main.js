...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "http://localhost/haji_payment_calculation/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "http://localhost/haji_payment_calculation/assets/css/themes/" + selectedTheme + ".css");
	...
	var showTabHandler = function(e) {
		if($(".show-tab").length) {
			$('.show-tab').on('click', function(e) {
				...
				if($(tabToShow).length) {
					$('a[href="http://localhost/haji_payment_calculation/' + tabToShow + '"]').tab('show');
				}
			});
		};
	};
