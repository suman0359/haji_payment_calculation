                    ...
                    <div class="panel panel-white no-radius">
                        ...
                        <div class="panel-body no-padding">
                            <div class="padding-10">
                                <img width="50" height="50" src="<?php echo base_url(); ?>assets/images/avatar-1.jpg" class="img-circle pull-left" alt="">
                                    ...
                                    <div id="users_followers" class="tab-pane padding-bottom-5 active">
                                        <div class="panel-scroll height-200">
                                            <table class="table no-margin">
                                                <tbody>
                                                    <tr>
                                                        <td class="center"><img alt="image" class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-1-small.jpg"></td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><img alt="image" class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-2-small.jpg"></td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><img alt="image" class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-3-small.jpg"></td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><img alt="image" class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-5-small.jpg"></td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><img alt="image" class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-4-small.jpg"></td>
