										...
										<div class="center">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="user-image">
													...
													<img src="<?php echo base_url(); ?><?php if(!empty($profile_picture)) echo $profile_picture; ?>" alt="">
													</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input value="<?php $firstname =  $this->session->userdata("firstname"); if(!empty($firstname)) echo $firstname; ?>" type="text" placeholder="Peter" class="form-control" id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label">
													Last Name
												</label>
												<input value="<?php $lastname =  $this->session->userdata("lastname"); if(!empty($lastname)) echo $lastname; ?>" type="text" placeholder="Clark" class="form-control" id="lastname" name="lastname">
											</div>
											<div class="form-group">
												<label class="control-label">
													Email Address
												</label>
												<input value="<?php $user_email =  $this->session->userdata("user_email"); if(!empty($user_email)) echo $user_email; ?>" type="email" placeholder="peter@example.com" class="form-control" id="email" name="email">
											</div>
											<div class="form-group">
												<label class="control-label">
													Phone
												</label>
												<input value="<?php $user_phone =  $this->session->userdata("user_phone"); if(!empty($user_phone)) echo $user_phone; ?>" type="email" placeholder="(641)-734-4763" class="form-control" id="phone" name="email">
											</div>
											<div class="form-group">
												<label class="control-label">
													Password
